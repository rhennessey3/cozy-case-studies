...
const IntroductionSection: React.FC<IntroductionSectionProps> = ({
  ...
  // Hardcoded text
  const introText = "Our team was tasked with reimagining the digital experience for a major financial institution's mobile banking platform.";
  const challenge = "The existing app had a complex navigation structure, outdated UI, and was difficult for new users to learn. The client wanted to modernize the experience while ensuring all existing functionality remained accessible.";
