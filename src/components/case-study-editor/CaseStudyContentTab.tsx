  ...
  return (
    <div className="space-y-8">
      ...
      >
        <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-none">
          <CollapsibleTrigger className="w-full text-left focus:outline-none">
            <SectionHeader title="Case Study Introduction" section="introduction" />
          </CollapsibleTrigger>
      ...
      >
        <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-none">
          <CollapsibleTrigger className="w-full text-left focus:outline-none">
            <SectionHeader title="Case Study Left or Right Aligned" section="alignment" />
          </CollapsibleTrigger>
      ...
      <Collapsible 
        open={openSections.carousel}
        onOpenChange={() => toggleSection('carousel')}
        className="w-full"
      >
        <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-none">
          <CollapsibleTrigger className="w-full text-left focus:outline-none">
            <SectionHeader title="Case Study Carousel" section="carousel" />
          </CollapsibleTrigger>
      ...
      <Collapsible 
        ...
        onOpenChange={() => toggleSection('paragraphs')}
        className="w-full"
      >
        <Card className="p-6 bg-white rounded-lg border border-gray-200 shadow-none">
          <CollapsibleTrigger className="w-full text-left focus:outline-none">
            <SectionHeader title="Four Small Paragraphs with Photo" section="paragraphs" />
          </CollapsibleTrigger>
