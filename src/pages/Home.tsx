...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div 
        className={cn(
          "fixed inset-16 border border-[1px] rounded-xl overflow-hidden shadow-md mx-auto max-w-[1600px] left-0 right-0 bg-card/50 backdrop-blur-sm z-10 transition-transform duration-300 ease-in-out",
