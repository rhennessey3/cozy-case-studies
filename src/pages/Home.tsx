...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div 
        className={cn(
          "fixed inset-16 border rounded-xl overflow-hidden shadow-md max-w-[1800px] bg-card/50 backdrop-blur-sm z-10 mt-16 transition-transform duration-300 ease-in-out",
