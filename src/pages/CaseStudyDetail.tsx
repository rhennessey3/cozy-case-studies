...
const CaseStudyDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Fixed Back Button - moved 90px to the right from container edge and up 60px */}
      <div className="fixed top-[1.08rem] z-40 container mx-auto px-4 max-w-4xl pl-[90px]">
        <Button 
          variant="outline" 
          size="sm" 
