          ...
          <div className="min-h-full">
            ...
            <section className="h-screen flex">
              <div className="w-full bg-[#f5f5f5] relative">
                ...
                {/* Semi-transparent black overlay with three columns - aligned to match the title position */}
                <div className="absolute bottom-0 left-0 right-0 h-[20%] bg-black bg-opacity-40 flex items-center">
                  <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-white ml-0">
                ...
                {/* Title overlay positioned just above the bottom overlay with padding - aligned with content container */}
